...
export default function Studentattendance({ sidebarOpen, toggleSidebar }) {
  ...
  return (
    <div id="page-content-wrapper">
      <Navbar title={"Staff Attendance"} toggleSidebar={toggleSidebar} />
      ...
      >
        <div
          ...
          style={{ backgroundColor: "rgba(189, 195, 199, 0.1)",color:"#011B53",borderColor:'none' }}
        >
          <div className="container-fluid justify-content-between  d-flex  px-4 pt-3 ">
            ...
            <div className=" d-flex align-item-center">
                ...
                <input onChange={handleChange} className="mr-2 rounded-pill" type="date"  placeholder="Date"  />
          ...
          >
          {date==='2021-05-30'? TeacherAttendancedata.map((staff, index) => {
              return (
                <tr key={index}>
                  <td>{staff.id}</td>
